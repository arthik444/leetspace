...
export function ActivityHeatmap({ data = [], className = "" }) {
  ...
  const getIntensityClass = (level) => {
    const intensityClasses = {
      ...
      1: "bg-green-100 dark:bg-green-900/40 border border-green-200 dark:border-green-800/50",
      2: "bg-green-200 dark:bg-green-800/60 border border-green-300 dark:border-green-700/70", 
      3: "bg-green-300 dark:bg-green-700/80 border border-green-400 dark:border-green-600/80",
      4: "bg-green-400 dark:bg-green-600/90 border border-green-500 dark:border-green-500/90"
    };
