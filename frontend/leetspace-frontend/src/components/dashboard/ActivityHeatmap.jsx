...
export function ActivityHeatmap({ data = [], className = "" }) {
  ...
  const getIntensityClass = (level) => {
    const intensityClasses = {
      ...
      1: "bg-green-100 dark:bg-green-900 border border-green-200 dark:border-green-800",
      2: "bg-green-300 dark:bg-green-700 border border-green-400 dark:border-green-600", 
      3: "bg-green-500 dark:bg-green-500 border border-green-600 dark:border-green-400",
      4: "bg-green-600 dark:bg-green-400 border border-green-700 dark:border-green-300"
    };
