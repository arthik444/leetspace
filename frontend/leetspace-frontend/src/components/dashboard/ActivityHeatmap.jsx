...
export function ActivityHeatmap({ data = [], className = "" }) {
  ...
  const getIntensityClass = (level) => {
    const intensityClasses = {
      ...
      1: "bg-gray-200 dark:bg-zinc-700 border border-gray-300 dark:border-zinc-600",
      2: "bg-gray-300 dark:bg-zinc-600 border border-gray-400 dark:border-zinc-500", 
      3: "bg-gray-400 dark:bg-zinc-500 border border-gray-500 dark:border-zinc-400",
      4: "bg-gray-500 dark:bg-zinc-400 border border-gray-600 dark:border-zinc-300"
    };
